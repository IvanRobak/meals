...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  var _vegaterianFreeFilterSet = false;
  ...
  void initState() {
    ...
    _vegaterianFreeFilterSet = widget.currentFilter[Filter.vegetarian]!;
  }
      ...
      body: PopScope(
        ...
        child: Column(
          children: [
            ...
            SwitchListTile(
              value: _vegaterianFreeFilterSet,
              onChanged: (isChecked) {
                setState(() {
                  _vegaterianFreeFilterSet = isChecked;
                });
              },
              title: Text(
                'Vegaterian free',
